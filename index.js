...
const n_contributors = GAMES_JSON.reduce((acc, game) => {
    return acc += game.backers;
}, 0);

// set the inner HTML using a template literal and toLocaleString to get a number with commas
contributionsCard.innerHTML = `${n_contributors.toLocaleString("en-US")}`;
...
const n_unfunded = GAMES_JSON.reduce((acc, game) => {
...
const displayStr = `
    ...
    Currently, ${n_unfunded} ${n_unfunded > 1 ? "games remain unfunded" : "game remains unfunded"}.
